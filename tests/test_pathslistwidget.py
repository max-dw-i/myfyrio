...
from doppelganger.gui import multiselectionfiledialog, pathslistwidget
...
PLW_MODULE = 'doppelganger.gui.pathslistwidget.'
...
class TestPathsListWidgetMethodAddPath(TestPathsListWidget):
    ...
    DIALOG = PLW_MODULE + 'MultiSelectionFileDialog'
